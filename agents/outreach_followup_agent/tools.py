...
_TOOL_SERVICES: OutreachToolServices | None = None
...
def configure_tool_services(services: OutreachToolServices) -> None:
    ...
    global _TOOL_SERVICES
    _TOOL_SERVICES = services
...
def _run(operation: Callable[[], Any]) -> dict[str, Any]:
    ...
    try:
        ...
        return _error("VALIDATION_ERROR", str(error), retryable=False)
