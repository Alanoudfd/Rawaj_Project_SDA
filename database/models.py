...
# Paste this entire block at the END of database/models.py.
#
# It intentionally leaves existing Restaurant, ResearchRun, QualificationRun,
# Strategy, and OutreachEvent models unchanged.
