...
REPORT = {
    ...
    "marketing_gaps": [
        {"gap": "Inactivity", "severity": "High", "priority": 1, "recommendation_focus": "Consistency",
         "evidence": ["13 posts in the last 30 days.", "Dash Social reports 2-3 posts a week.", "Research signal: activity_01."]},
        {"gap": "Narrow mix", "severity": "Moderate", "priority": 2, "recommendation_focus": "Mix", "evidence": ["Reels are 40.0% of the content."]},
    ],
